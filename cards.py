...
zantetsu = AttackCard(
    ...
    miss_msg="{a} rises and attempts a Zan-Tetsu strike, but the blade finds only air!",
...
kesa = AttackCard(
    ...
    is_special=True,
    success_msg="{a} drops low and launches a piercing Kesa strike! The blade finds its mark!",
    miss_msg="{a} drops low and attempts a Kesa strike, but fails to connect!",
...
low_strike = AttackCard(
    ...
    is_special=False,
    success_msg="{a}'s low strike catches {b} off guard!",
    miss_msg="{a} attempts a low strike, but misses completely!",
...
high_strike = AttackCard(
    ...
    is_special=False,
    success_msg="{a}'s high strike crashes down onto {b}!",
    miss_msg="{a} goes for a high strike, but it misses the mark!",
...
balanced_strike = AttackCard(
    ...
    is_special=False,
    emoji=None,
    success_msg="{a}'s swift balanced strike connects with {b}!",
    miss_msg="{a} attempts a balanced strike, but finds no target!",
...
charge = MoveAction(
    name="Charge",
    magnitude=2,
    msg="{a} charges forward two steps! ",
    button_colour="blue",
    changes_stance=False,
